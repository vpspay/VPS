...
RESOURCES += src/qt/vps.qrc src/qt/vps_locale.qrc

TRANSLATIONS += src/qt/locale/vps_bg.ts \
                src/qt/locale/vps_de.ts \
                src/qt/locale/vps_en.ts \
                src/qt/locale/vps_es.ts \
                src/qt/locale/vps_fi.ts \
                src/qt/locale/vps_fr.ts \
                src/qt/locale/vps_it.ts \
                src/qt/locale/vps_ja.ts \
                src/qt/locale/vps_pl.ts \
                src/qt/locale/vps_pt.ts \
                src/qt/locale/vps_ru.ts \
                src/qt/locale/vps_sk.ts \
                src/qt/locale/vps_sv.ts \
                src/qt/locale/vps_vi.ts \
                src/qt/locale/vps_zh_CN.ts \
                src/qt/locale/vps_zh_TW.ts
