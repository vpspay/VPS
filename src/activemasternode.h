...
private:
    ...
    /// Get 10000 VPS input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 VPS - checking if valid masternode)
