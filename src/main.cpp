...
#if defined(NDEBUG)
#error "VPS cannot be compiled without assertions."
#endif
 ...
 */
//CFeeRate minRelayTxFee = CFeeRate(250000);
...
const string strMessageMagic = "VPS Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight > 1 && nHeight <= 200000) {
		nSubsidy = 5 * COIN;
	} else if (nHeight > 200000 && nHeight <= 500000) {
		nSubsidy = 7 * COIN; 
	} else if (nHeight > 500000 && nHeight <= 800000) {
		nSubsidy = 9 * COIN;
	} else if (nHeight > 800000 && nHeight <= 1200000) {
		nSubsidy = 11 * COIN;
	} else if (nHeight > 1200000 && nHeight <= 1500000) {
		nSubsidy = 13 * COIN;
