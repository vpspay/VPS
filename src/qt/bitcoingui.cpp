                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VPS-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VPS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vps: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VPSPAY Core"), this);
    aboutAction->setStatusTip(tr("Show information about VPSPAY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VPS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VPS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VPS addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the VPSPAY Core help message to get a list with possible VPS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VPSPAY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VPS network", "", count));
}
...
{
    QString strTitle = tr("VPSPAY Core"); // default title
