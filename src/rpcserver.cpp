...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchain", "getblockbyheight", &getblockbyheight, true, false, false},
        ...
        /* VPS features */
        {"vps", "masternode", &masternode, true, true, false},
        {"vps", "masternodelist", &masternodelist, true, true, false},
        {"vps", "mnbudget", &mnbudget, true, true, false},
        {"vps", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"vps", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vps", "mnsync", &mnsync, true, true, false},
        {"vps", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vpsd, or the -server option to vps-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vps-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15157/\n";
}
